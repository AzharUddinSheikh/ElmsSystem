...
{% block body %}Add Empployee Panel{% endblock %}
{% block head %}
...
{% block content %}
    <div class="w-75 container">
      {% if session.added %} 
        <div class="container valid alert alert-warning my-3" role="alert">{{session.added}}</div>
      {% endif %}
        <h2 class="mt-5">Fill Out The Detail With Unique Email Address</h2>
